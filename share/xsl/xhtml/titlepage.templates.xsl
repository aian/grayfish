...
<xsl:template name="article.titlepage.recto">
  ...
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="d:info/d:keywordset"/><!-- 2021.11.09 ADD -->
...
<!-- 2021.11.09 ADD -->
<xsl:template match="d:keywordset" mode="article.titlepage.recto.auto.mode">
<div xsl:use-attribute-sets="article.titlepage.recto.style">
<xsl:apply-templates select="." mode="article.titlepage.recto.mode"/>
</div>
</xsl:template>
